...
public class UserDaoImpl implements UserDao {
    private static final String FIND_ALL_ENTITIES_SQL
            ...
            " from shopping_card.user as u LEFT OUTER JOIN" +
            " (shopping_card.user_ordered_article as uoa LEFT OUTER JOIN shopping_card.article as a ON a.id = uoa.articleId)" +
            " ON u.id = uoa.userId";
